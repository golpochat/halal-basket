...
export const UtilityIcons = {
  ...
  menu: utilIcon([p("M4 7h16", "a"), p("M4 12h16", "b"), p("M4 17h16", "c")]),
  close: utilIcon([p("M6 6l12 12", "a"), p("M18 6L6 18", "b")]),
  chevronUp: utilIcon([p("M6 15l6-6 6 6", "c")]),
  chevronDown: utilIcon([p("M6 9l6 6 6-6", "c")]),
  chevronLeft: utilIcon([p("M15 6l-6 6 6 6", "c")]),
  chevronRight: utilIcon([p("M9 6l6 6-6 6", "c")]),
  arrowUp: utilIcon([p("M12 19V5", "shaft"), p("M5 12l7-7 7 7", "head")]),
  arrowDown: utilIcon([p("M12 5v14", "shaft"), p("M19 12l-7 7-7-7", "head")]),
  heart: utilIcon([
    p(
      "M12 20.5s-7.5-4.4-9.2-9.1C1.3 7.6 3.4 4.5 6.8 4.5c1.9 0 3.4 1 4.2 2.3.8-1.3 2.3-2.3 4.2-2.3 3.4 0 5.5 3.1 4 6.9-1.7 4.7-9.2 9.1-9.2 9.1z",
      "h",
    ),
  ]),
  heartFilled: utilIcon([
    createElement("path", {
      key: "h",
      d: "M12 20.5s-7.5-4.4-9.2-9.1C1.3 7.6 3.4 4.5 6.8 4.5c1.9 0 3.4 1 4.2 2.3.8-1.3 2.3-2.3 4.2-2.3 3.4 0 5.5 3.1 4 6.9-1.7 4.7-9.2 9.1-9.2 9.1z",
      fill: "currentColor",
      stroke: "currentColor",
      strokeWidth: 1.5,
  ...
  eye: utilIcon([
    p("M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z", "lid"),
    c(12, 12, 3, "pupil"),
  ]),
  eyeOff: utilIcon([
    p("M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94", "a"),
    p("M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19", "b"),
    p("M14.12 14.12a3 3 0 11-4.24-4.24", "iris"),
    p("M1 1l22 22", "slash"),
  ]),
  refresh: utilIcon([
  ...
  ban: utilIcon([c(12, 12, 9, "ring"), p("M6.5 6.5l11 11", "slash")]),
  unlock: utilIcon([
